...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
   ...
   // private UserLoginTask mAuthTask = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textviewSignIn = (TextView) findViewById(R.id.textview_for_SignIn);
        ...
        fb_login_button = (LoginButton) findViewById(R.id.fb_register);
        ...
        fb_login_button.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onCancel() {
                Toast.makeText(getApplicationContext(), "Cancel Application", Toast.LENGTH_SHORT).show();
            }
    ...
    private void attemptLogin() {
      ...
      // Check for a valid empty password.
        if (TextUtils.isEmpty(password)) {
            mPasswordView.setError("This field is empty");
            focusView = mPasswordView;
            cancel = true;
        }
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if(task.isSuccessful()){
                                ...
                                //FirebaseUtilData.addUser(email);
