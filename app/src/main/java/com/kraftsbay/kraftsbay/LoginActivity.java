...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.Lemail);
        populateAutoComplete();

        mPasswordView = (EditText) findViewById(R.id.Lpassword);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.Lemail_sign_in_button);
        ...
        textviewSignUp = (TextView) findViewById(R.id.textview_for_SignUp);
...

    {
        ...
        //   intent.putExtra("ComingActivity",activity);
